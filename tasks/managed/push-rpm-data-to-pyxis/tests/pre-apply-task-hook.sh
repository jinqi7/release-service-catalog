...
kubectl create secret generic test-push-rpm-data-to-pyxis-cert --from-literal=cert=THIS_SHOULD_NOT_BE_EXPOSED --from-literal=key=THIS_SHOULD_NOT_BE_EXPOSED
